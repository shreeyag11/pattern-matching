public class PatternMatching {
	...
	public static int[] ShiftTable(String pattern) { //Shift table for BMHorspool
		int m = pattern.length();
	...
	public static int[] HorspoolMatching(String text, String pattern) { //BMHorspool matching method
	...
	public static void main(String[] args) {
		...
		int[] BMHorspool = HorspoolMatching(text, pattern);
		...
		System.out.print("place: "+BMHorspool[0]+", "+"comp: "+BMHorspool[1]+"  |  ");
		System.out.print("place: "+KMP[0]+", "+"comp: "+KMP[1]+"  |  "+"Execution Time : "+(System.currentTimeMillis() - startTime));
        System.out.println();
